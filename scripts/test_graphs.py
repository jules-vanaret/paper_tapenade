...
labels_norm = predict_lennedist(one_view_norm, (1/0.621, 1/0.621, 1/0.621), normalize=False)
...
labels_norm2 = predict_lennedist(two_views_norm, (1/0.621, 1/0.621, 1/0.621), normalize=False)
