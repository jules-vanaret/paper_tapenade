...
# ax.plot(Z,Precision_c,"o-",color=cset.rose,label='precision',linewidth=4)
# ax.plot(Z,Recall_c,"o-",color=cset.cyan,label='recall',linewidth=4)
# ax.plot(Z,Precision_u,"x--",color=cset.rose,label='precision with global normalization',linewidth=4)
...
plt.legend()
fig.tight_layout()
# plt.savefig(Path(folder)/"S2d_plot1.svg")
plt.show()
